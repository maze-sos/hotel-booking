<footer class="footer">
            ...
            <ul class="ftco-footer-social p-0">
              <li class="ftco-animate"><a href="<?php echo APPURL; ?>/about.php" target="_blank" data-toggle="tooltip" data-placement="top" title="Twitter"><span class="fa fa-twitter"></span></a></li>
              <li class="ftco-animate"><a href="<?php echo APPURL; ?>/about.php" target="_blank" data-toggle="tooltip" data-placement="top" title="Facebook"><span class="fa fa-facebook"></span></a></li>
              <li class="ftco-animate"><a href="<?php echo APPURL; ?>/about.php" target="_blank" data-toggle="tooltip" data-placement="top" title="Instagram"><span class="fa fa-instagram"></span></a></li>
            </ul>
					</div>
				</div>
			</div>
			<div class="w-100 mt-5 border-top py-5">
	          ...
	          <div class="col-md-6 col-lg-8">
	            ...
	            <p class="copyright mb-0">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This project is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="<?php echo APPURL; ?>/about.php" target="_blank">GROUP 2</a></p>
	          </div>
