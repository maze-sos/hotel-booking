...
define("HOTELSIMAGES", "http://localhost/hotel-booking/admin-panel/hotels-admins/hotels_images");
define("ROOMSIMAGES", "http://localhost/hotel-booking/admin-panel/rooms-admins/rooms_images");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
			...
			<div class="container">
				<div class="row justify-content-between">
						<div class="col d-flex align-items-center">
							<p class="mb-0 phone"><span class="mailus">Phone no:</span> <a href="#">+2349032253937</a> or <span class="mailus">email us:</span> <a href="#">vacationrental@gmail.com</a></p>
						</div>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <?php if(!isset($_SESSION['username'])) : ?>
			  ...
			  <!-- <li class="nav-item"><a href="<?php //echo APPURL; ?>/admin-panel/admins/login-admins.php" class="nav-link">Admin Login</a></li> -->
            <?php else : ?>
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
					...
					<li><a class="dropdown-item" href="<?php echo APPURL; ?>/users/accountdetails.php?id=<?php echo $_SESSION['id']; ?>">Account Details</a></li>
