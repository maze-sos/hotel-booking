...
if(isset($_GET['id'])){
	...
	$hotel = $conn->query("SELECT * FROM hotels WHERE status = 1 AND id='$id'");
	$hotel->execute();
...
?>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('<?php echo HOTELSIMAGES; ?>/<?php echo $singleHotel->image ?>');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Home <i class="fa fa-chevron-right"></i></a></span> <span><?php echo $singleHotel->name; ?><i class="fa fa-chevron-right"></i></span></p>
            <h1 class="mb-0 bread"><?php echo $singleHotel->name; ?></h1>
          </div>
        </div>
      </div>
    </section>
